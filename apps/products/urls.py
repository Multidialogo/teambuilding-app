...
urlpatterns = [
    ...
    path('purchasable/', views.list_purchasable, name='product-list-purchasable'),
    ...
    path('producers/orders/', views.producer_list_purchasable, name='product-producer-list-purchasable'),
    ...
    path('producers/<int:producer_id>/send-order/', views.producer_order_create, name='product-producer-order-create'),
    path('producers/<int:producer_id>/send-order/<str:country>/', views.producer_order_create, name='product-producer-order-create'),
