...
from teambuilding.tastepurchase.forms import TasteEventForm
from teambuilding.tastepurchase.models import TasteEvent
from teambuilding.tastepurchase.forms import ProductForm, ProducerForm, ProducerPostalAddressForm
from teambuilding.tastepurchase.models import Product, Producer
from teambuilding.site.models import Notification

from .utils import model_to_post_data
...
class FixtureTestCase(TestCase):
    fixtures = ['./www/tests/fixtures/fixture.yaml', ]
