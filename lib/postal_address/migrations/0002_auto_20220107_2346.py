# Generated by Django 3.2.9 on 2022-01-07 23:46

from django.db import migrations


def insert_data(apps, schema_editor):
    Country = apps.get_model('postal_address', 'Country')
    CountryAdminLevelMapping = apps.get_model('postal_address', 'CountryAdminLevelMapping')
